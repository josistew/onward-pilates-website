    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
        <Link href="/" className="flex flex-col items-center gap-0.5">
          <span className={`font-serif text-3xl tracking-[0.05em] ${textColor} lg:text-4xl`} style={{ fontWeight: 100 }}>
            ONWARD
          </span>
          <span className={`font-sans text-[7px] font-normal tracking-[0.15em] ${textColor} lg:text-[8px]`}>
