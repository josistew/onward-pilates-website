      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1800px] flex-col px-6 pt-24 pb-16 md:px-10 md:pt-28 lg:flex-row lg:items-stretch lg:gap-0 lg:px-0 lg:pt-0 lg:pb-0">
        ...
        <div className="relative mt-12 lg:mt-0 lg:w-[45%]">
          ...
          >
            ...
            {/* Bottom detail card */}
            <div 
              className={`absolute -bottom-6 left-6 z-10 bg-[#13273F] p-5 md:left-0 lg:-left-16 lg:bottom-24 transition-all duration-700 delay-900 ${
            ...
            >
              ...
              <p className="mt-1 font-serif text-2xl tracking-tight text-[#F5F2EC]">
                2023
              </p>
            </div>
